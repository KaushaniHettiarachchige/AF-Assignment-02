...
function CountryCard({ country }) {
    return (
        <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 p-4 rounded-lg shadow-md hover:shadow-lg transition">
            ...
            <p className="text-gray-700 dark:text-gray-300"><strong>Languages:</strong> {country.languages ? Object.values(country.languages).join(', ') : "N/A"}</p>
        </div>
    );
}
